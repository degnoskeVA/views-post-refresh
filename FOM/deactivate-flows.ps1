...
(gc force-app/main/default/flowDefinitions/CF_Account_Related_Functionality_Edit_Account.flowDefinition-meta.xml -TotalCount 3)[-1] |  Set-Content cf-account-output.txt 
...
(gc force-app/main/default/flowDefinitions/CF_Move_Contact_To_New_Office_Process.flowDefinition-meta.xml -TotalCount 3)[-1] |  Set-Content cf-contact-utility-output.txt 
...
(gc force-app/main/default/flowDefinitions/CF_Mark_User_As_Inactive.flowDefinition-meta.xml -TotalCount 3)[-1] |  Set-Content cf-mark-inactive-output.txt 
...
(gc force-app/main/default/flowDefinitions/CF_User_When_the_Contact_is_Created_Process.flowDefinition-meta.xml -TotalCount 3)[-1] |  Set-Content cf-user-when-contact-is-created-output.txt 
...
(gc force-app/main/default/flowDefinitions/Create_FOM_Data_Collection_Requests.flowDefinition-meta.xml -TotalCount 3)[-1] |  Set-Content create-fom-data-collection-output.txt 
